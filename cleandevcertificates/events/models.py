...
class Event(models.Model):
    ...
    place = models.ForeignKey('core.Person', verbose_name=_(
        u'Local'), related_name='place',
        limit_choices_to={'kind__in': ['U', 'P']})
    support = models.ManyToManyField('core.Person', verbose_name=_(
        u'apoio'), limit_choices_to={'kind__in': ['U', 'P']})
    complement = models.TextField(_(u'Complemento'), blank=True)
    speaker = models.ForeignKey('core.Person', verbose_name=_(
        u'Palestrante'), related_name='speaker',
