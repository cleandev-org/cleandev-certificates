    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kind', models.CharField(default=b'S', max_length=1, verbose_name='tipo', choices=[(b'S', 'Aluno'), (b'U', 'Universidade'), (b'P', 'Local')])),
                ...
                ('display_name', models.CharField(max_length=100, verbose_name='apelido')),
                ...
                ('image', models.URLField(verbose_name='URL imagem', blank=True)),
